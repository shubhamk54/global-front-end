...
const mockCampaignDataInput = [{
  id: 1, name: 'Divavu', startDate: '9/19/2019', endDate: '9/20/2019', Budget: 88377,
},
{
...
const mockCampaignDataOutput = [{
  id: 1, name: 'Divavu', startDate: '9/19/2019', endDate: '9/20/2019', Budget: 88377, active: { title: 'Inactive', type: 'danger' },
},
{
...
describe('Test campaign data business logic extraction', () => {
  ...
  it('Test output data when name filter applied as pattern', () => {
    expect(campaignDataSelector({
      gridData: mockCampaignDataInput, startDate: new Date(2018, 2, 1), endDate: new Date(2019, 11, 12), searchValue: 'a',
    })).toHaveLength(3);
  });

  it('Test output data when exact name filter is applied', () => {
    expect(campaignDataSelector({
      gridData: mockCampaignDataInput, startDate: new Date(2018, 2, 1), endDate: new Date(2019, 11, 12), searchValue: 'Layo',
    })).toEqual([{
      id: 5,
      name: 'Layo',
      startDate: '1/1/2019',
